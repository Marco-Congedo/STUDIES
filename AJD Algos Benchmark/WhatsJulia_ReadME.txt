...
2) install Atom from https://atom.io/ and open it
3) in Atom's menu, 
...
Note:
In some rare cases you may need to add the path to Julia since for some reason
it is not accessible to Atom. 
...
Once the installation in Atom terminated, go to File > Open File 
and select the "QNLogLikeBenchmark.jl" script, then continue with the
directions in the header of the script.